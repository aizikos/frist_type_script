...
import { basketProduct, deleteProduct } from "../../redux/reducer/action";
    ...
    return (
        <div className="containers">
            <div className=" flex gap-8 flex-wrap">
                {
                    product.map((el) => (
                        <div key={el.id} className="w-[330px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-indigo-500">
                            <img className="w-[300px] p-8 rounded-t-lg" src={el.img} alt="product image" />
                            <div className="px-5 pb-5">
                                ...
                                <div className="mt-[20px] flex gap-3">
                                    <button onClick={() => dispatch(deleteProduct(el.id))} type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                        <FaTrash />
                                    </button>
